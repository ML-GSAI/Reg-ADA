...
def setup_training_loop_kwargs(
    ...
    # Pre-trained model.
    pre_model    = None, # The name of the pre-trained model
    lamd       = 0.0, # Set the hyperparameter of the loss function for pre-trained model
):
...
### Pre-trained models.
@click.option('--lamd', help='Set the hyperparameter of the loss function for pre-trained model [default: 0]', type=float, metavar='FLOAT')
@click.option('--pre_model', help='The name of the pre-trained model [default: None]')
